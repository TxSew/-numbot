...
export default function ScoreBoardInventory() {
    ...
    const handleLogout = () => {
        ...
        // Show a success message (assuming you have a showSnackbar function)
        showSnackbar('Logout successful', 'success');
      
        // Reload the page to ensure all state and UI reflect the logout
        setTimeout(() => {
    ...
    return (
        <g className="bot-logout" >
            ...
            >
                ...
                <image
                    href="https://static.numbots.com/data/custom-shack/Owl/owl-head-1.svg"
                    x={isSmall ? 16 : 14}
                    y={isSmall ? 10 : 7}
                    width={`${imageSize}px`}
                    height={`${imageSize}px`}
        ...
        // <g className="bot" style={{ cursor: 'pointer' }}>
        //     <svg
        //         xmlns="http://www.w3.org/2000/svg"
